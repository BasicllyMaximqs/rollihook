...
void interfaces::Setup() noexcept
{
	...
	game_ev_manager = Capture<IGameEventManager2>("engine.dll", "GAMEEVENTSMANAGER002");
	input = *reinterpret_cast<CInput**>(memory::PatternScan("client.dll", "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10") + 0x1);
